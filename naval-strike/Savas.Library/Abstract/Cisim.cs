...
namespace Savas.Library.Abstract
{
    internal abstract class Cisim : PictureBox, IHareketEden //her cisim bir resimdir.
        //Cisim sınıfı, hareketle ilgili birçok özelliğe ve yönteme sahiptir
    {
        ...
        protected Cisim(Size hareketAlaniBoyutlari) 
        {
            ...
            HareketAlaniBoyutlari = hareketAlaniBoyutlari; //hareket alanı boyutlarına cisme gönderilen parametre atanıyor.
